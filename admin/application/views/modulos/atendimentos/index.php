        ...
        <div class="col-md-12">
            <div class="panel panel-white has-shadow">
				<div class="panel-heading clearfix">
					...
					<a href="<?php echo site_url("atendimentos/criar");?>" class="btn btn-primary pull-right"><span class="fa fa-plus"></span> Novo </a>
				</div>
						...
						<table class="display table table-hover mg-top-20 tablesaw tablesaw-stack" data-tablesaw-mode="stack">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center"><a class="btn btn-primary" href="<?php echo base_url().'avaliacoes/index/'. $item->id;?>"><i class="fa fa-eye"></i></a></td>
